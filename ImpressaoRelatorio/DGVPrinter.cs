...
namespace ImpressaoRelatorio //AllocationRequest
{    
    ...
    public class DGVPrinter
    {
        ...
        //Lista de Colunas a serem impressas
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("Times New Roman", 8, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("Times New Roman", 18, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Black;
            subtitlefont = new Font("Times New Roman", 12, FontStyle.Bold, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("Times New Roman", 10, FontStyle.Bold, GraphicsUnit.Point);
        ...
        private void SetupPrintRange()
        {
            ...
            if (PrintRange.Selection == printRange)
            {
                ...
                if (0 != dgv.SelectedRows.Count)
                {
                    ...
                    foreach (DataGridViewColumn col in dgv.Columns) if ((col.Visible)&&(ListColumns.Contains(col.Name)))
                ...
                else if (0 != dgv.SelectedColumns.Count)
                {
                    ...
                    foreach (DataGridViewColumn col in dgv.SelectedColumns)
                        if ((col.Visible)&& (ListColumns.Contains(col.Name)))
                            tempcolstoprint.Add(col.DisplayIndex, col);
                }
            ...
            else if (PrintRange.CurrentPage == printRange)
            {
                ...
                foreach (DataGridViewColumn col in dgv.Columns) if ((col.Visible)&& (ListColumns.Contains(col.Name))) tempcolstoprint.Add(col.DisplayIndex, col);
            }
